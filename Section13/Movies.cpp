...
Movies::~Movies() {
  ...
  /*************************************************************************
    ...
    *********************************************************************/
bool Movies::add_movie(std::string name_, std::string rating, int watched) 
{
    for (const Movie & ele : movies)
    {
        if(name_ == ele.get_name())
                return false;
    }
        Movie movie_(name_,rating,watched);
        movies.emplace_back(movie_);
        return true;
}
 ...
 /*************************************************************************
    ...
    *********************************************************************/
bool Movies::increment_watched(std::string name_) 
{
    for ( Movie & ele:movies)
    {
        if(name_ == ele.get_name())
        {
            ele.increment_watched();
            return true;
        }
    }
    return false;
